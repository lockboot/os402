...
use crate::os::{ResourceCapacity, ResourceUsage, SystemUsage};
...
pub async fn health_handler(
    ...
    let system = SystemInfo {
        capacity: crate::os::TaskManager::detect_system_resources()
            .unwrap_or_else(|_| state.tasks.capacity.clone()),
        usage: crate::os::TaskManager::detect_system_usage()
            .unwrap_or_default(),
    };
