            ...
            <div id="main-content">
                ...
                <div class="section" id="duration-section">
                    ...
                    <div class="duration-control">
                        ...
                        <div class="duration-display">
                            <span id="duration-value">0 seconds</span>
                            <span id="duration-range"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="price-box">
                        ...
                        <div class="price-row">
                            <span class="price-label">Network</span>
                            <span class="price-value" id="network"></span>
                        </div>
                        <div class="price-row">
                            <span class="price-label">Recipient</span>
    ...
    (function() {{
        ...
        function init() {{
            ...
            if (offer?.limits) {{
                ...
                limitsEl.innerHTML = `
                    <div class="limit-item">
                        <div class="limit-value">${{offer.limits.ram_mb}}</div>
                        <div class="limit-label">RAM MB</div>
                    </div>
                    <div class="limit-item">
                        <div class="limit-value">${{offer.limits.cpu_units}}</div>
                        <div class="limit-label">CPU</div>
                    </div>
                    <div class="limit-item">
                        <div class="limit-value">${{offer.limits.wall_time_secs}}</div>
                        <div class="limit-label">Max Sec</div>
                    </div>
                `;
            }} else {{
            ...
            if (offer) {{
                ...
                const min = offer.min_duration_seconds || 1;
                const max = offer.max_duration_seconds || min;
                slider.min = min;
                slider.max = max;
                slider.value = min;
                selectedDuration = min;

                document.getElementById('duration-range').textContent =
                    min === max ? `${{min}}s fixed` : `${{min}}s - ${{max}}s`;
