    ...
    F: Facilitator + Sync,
{
    ...
    async fn supported(&self) -> Result<SupportedPaymentKindsResponse, Self::Error> {
        ...
        let response = self.supported_cache.get_or_try_init(|| async {
            ...
            // The asset address IS the owner's address, signaling this is auth not payment
            // Clients can detect this by seeing if a supported payment kind has
            // an asset address matching an address they control
    ...
    async fn create_test_settle_request(value: TokenAmount) -> (String, SettleRequest) {
        ...
        let request = SettleRequest {
            ...
            payment_requirements: PaymentRequirements {
                ...
                asset: MixedAddress::Evm("0x036CbD53842c5426634e7929541eC2318f3dCF7e".to_string()),
                extra: None,
            },
        };
